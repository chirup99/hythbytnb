        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center gap-1.5 text-[9px] text-gray-500 font-medium tracking-widest uppercase mt-1 w-full justify-end pl-[0px] pr-[0px]">
            ...
            <div className="relative inline-flex items-center ml-1">
              ...
              {/* Broken flying piece */}
              <div className="absolute -top-[1px] -right-[2px] rotate-[35deg]">
                <div className="w-[3px] h-[1px] bg-purple-400 rounded-full opacity-90 shadow-[0_0_4px_rgba(192,132,252,0.8)]" />
              </div>
            </div>
          </div>
        </div>
